...
window.onload = function () {
  ...
  if (savedSalary) totalSalary = parseInt(savedSalary);
...
function updateUI() {
  document.getElementById(" card1").innerHTML = "₹" + totalSalary + "<br>Total Salary";
  document.getElementById("card2").innerHTML = "₹" + totalExpense + "<br>Total Expense";
  document.getElementById("card3").innerHTML = "₹" + (totalSalary- totalExpense) + "<br>Remaining Balance";
  updateChart();
}
